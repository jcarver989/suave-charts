...
100)};c.prototype.draw=function(){if(!this.listenerBound)return window.addEventListener("resize",this.render),this.listenerBound=!0};c.prototype.remove=function(){var a,d;window.removeEventListener("resize",this.render);null!=this.tip&&this.tip.remove();a=this.svg.domElement;for(d=[];a.firstChild;)d.push(a.removeChild(a.firstChild));return d};return c}();var filterTicks$$module$target$coffeescript$filter_ticks,module$target$coffeescript$filter_ticks=filterTicks$$module$target$coffeescript$filter_ticks=function(c,a,d){var b,l;return"ordinal"===d?(b=a.domain(),l=Math.round(b.length/(c-2)),b.filter(function(a,d){return 0===d||a===b[b.length-1]?!0:0===d%l})):a.ticks(c)};var Axes$$module$target$coffeescript$axes,filterTicks$$module$target$coffeescript$axes,bind$$module$target$coffeescript$axes=function(c,a){return function(){return c.apply(a,arguments)}};filterTicks$$module$target$coffeescript$axes=module$target$coffeescript$filter_ticks;
...
this.yAxis=d3.svg.axis().scale(this.y).tickFormat(this.options.yLabelFormat).tickPadding(this.axisLabelPadding);"vertical"===this.options.layout?(this.xAxis.orient("bottom"),this.yAxis.orient("left")):(this.xAxis.orient("left"),this.yAxis.orient("bottom"))}extend$$module$target$coffeescript$bar_chart(a,c);a.prototype.render=function(){var a,b,c;this.svg.resize();c=this.y;b="vertical"===this.options.layout?(this.options.grid?this.yAxis.tickSize(-this.svg.width,0):void 0,{xTransform:"translate(0, "+
this.svg.height+")",yTransform:"",groupsTransform:function(b){return function(a){return"translate("+b.x(a)+", 0)"}}(this),xRange:[0,this.svg.width],yRange:[this.svg.height,0],barX:function(b){return function(a,d){return b.groupedX(d)}}(this),barY:function(b){return function(a){return b.y(a.value)}}(this),barWidth:function(b){return function(){return b.groupedX.rangeBand()}}(this),barHeight:function(b){return function(a){return b.svg.height-b.y(a.value)}}(this)}):(this.options.grid?this.yAxis.tickSize(-this.svg.height,
0):void 0,{xTransform:"",yTransform:"translate(0, "+this.svg.height+")",groupsTransform:function(b){return function(a){return"translate(0, "+b.x(a)+")"}}(this),xRange:[0,this.svg.height],yRange:[0,this.svg.width],barX:function(b){return function(b){return 0}}(this),barY:function(b){return function(a,d){return b.groupedX(d)}}(this),barHeight:function(b){return function(){return b.groupedX.rangeBand()}}(this),barWidth:function(b){return function(a){return b.y(a.value)}}(this)});this.x.rangeRoundBands(b.xRange,
.1);this.groupedX.rangeRoundBands([0,this.x.rangeBand()],this.options.barSpacing);this.y.range(b.yRange);this.xAxisSelection.attr("transform",b.xTransform).call(this.xAxis);this.yAxisSelection.attr("transform",b.yTransform).call(this.yAxis);this.groups.attr("transform",b.groupsTransform);this.bars.attr("x",b.barX).attr("y",b.barY).attr("width",b.barWidth).attr("height",b.barHeight);a=d3.behavior.drag().on("drag",function(a){var d,g,k;d=d3.select(this);k=Math.max(5,Math.min(b.yRange[0]-5,d3.event.y));
g=c.invert(k);d.attr("cy",k);d3.select(this.parentNode).select("rect").attr("height",b.barHeight({value:g})).attr("y",b.barY({value:g}));return a.value=g});return this.dots.attr("cx",function(a,d){return b.barX(a,d)+.5*b.barWidth()}).attr("cy",b.barY).attr("class","drag-handle").call(a)};a.prototype.draw=function(d){a.__super__.draw.call(this);return this.waitToBeInDom(function(b){return function(){return b.drawInternal(d)}}(this))};a.prototype.drawInternal=function(a){var b,c,e,f;c=function(){var c,
l,f,e;f=a.bars;e=[];c=0;for(l=f.length;c<l;c++)b=f[c],e.push("[object Array]"===Object.prototype.toString.call(b)?b:[b]);return e}();this.y.domain([0,d3.max(d3.merge(c,function(b){return d3.max(b)}))]);this.x.domain(a.labels);this.groupedX.domain(c[0].map(function(b,a){return a}));null!=this.options.ticks&&0<this.options.ticks&&this.xAxis.tickValues(filterTicks$$module$target$coffeescript$bar_chart(this.options.ticks,this.x,"ordinal"));"vertical"===this.options.layout?this.options.margin.left=this.calc.calcLeftMargin(this.yAxis,
this.options.margin.left):(this.x.rangeRoundBands([0,10],.1),this.options.margin.left=this.calc.calcLeftMargin(this.xAxis,this.options.margin.left,"x"));this.xAxisSelection=this.svg.chart.append("g").attr("class","x axis");this.yAxisSelection=this.svg.chart.append("g").attr("class","y axis");this.groups=this.svg.chart.selectAll(".barGroup").data(a.labels).enter().append("g").attr("class",function(b,a){return"barGroup barGroup-"+a+" "+b});this.barGroups=this.groups.selectAll(".bar").data(function(b,
a){return c[a].map(function(b){return{value:b}})}).enter().append("g").attr("class",function(b,a){return"bar bar-"+a});this.bars=this.barGroups.append("rect");this.dots=this.barGroups.append("circle").attr("r",5);this.options.tooltips&&(f=this.options.tooltipFormat,e=this.tip||(this.tip=new Tooltip$$module$target$coffeescript$bar_chart(document)),this.bars.on("mouseover",function(b){e.html(f(b.value));return e.show(this)}),this.bars.on("mouseout",function(b){return e.hide()}));return this.render()};
return a}(AbstractChart$$module$target$coffeescript$bar_chart);var AbstractChart$$module$target$coffeescript$donut_chart,DonutChart$$module$target$coffeescript$donut_chart,defaultDonutOptions$$module$target$coffeescript$donut_chart,bind$$module$target$coffeescript$donut_chart=function(c,a){return function(){return c.apply(a,arguments)}},extend$$module$target$coffeescript$donut_chart=function(c,a){function d(){this.constructor=c}for(var b in a)hasProp$$module$target$coffeescript$donut_chart.call(a,b)&&(c[b]=a[b]);d.prototype=a.prototype;c.prototype=new d;c.__super__=
...
yRange:[this.svg.height,0],xTransform:"translate(0, "+this.svg.height+")",yTransform:"",barsTransform:function(b){return function(a){return"translate("+b.x(a.x)+", "+b.y(a.y)+")"}}(this),barWidth:function(b){return function(c){return b.x(a.x+a.dx)-b.x(a.x)-1}}(this),barHeight:function(b){return function(a){return b.svg.height-b.y(a.y)}}(this)}):(this.options.grid?this.yAxis.tickSize(-this.svg.height,0):void 0,{xRange:[0,this.svg.height],yRange:[0,this.svg.width],xTransform:"",yTransform:"translate(0, "+
...
return a.area(b.values)}}(this));return this.dots.attr("cx",function(a){return function(b){return a.x(b.x)}}(this)).attr("cy",function(a){return function(b){return a.y(b.y+b.yTranslation)}}(this))};a.prototype.chooseInterpolation=function(a){return a.smooth?"monotone":"linear"};a.prototype.formatData=function(a,b){var c,e,f,g,k,x,m,h,n,p,z,A,q,r,y,t,u,v,w;null==b&&(b=!1);k=this.isTimeSeries&&"number"===typeof a.labels[0]?a.labels.map(function(a){return new Date(a)}):a.labels;u=t=q=r=null;n=[];m=a.lines;
f=c=0;for(x=m.length;c<x;f=++c)for(g in h=m[f],n.push({values:Array(h.values.length)}),h)p=h[g],"values"!==g&&(n[f][g]=p);f=p=0;for(x=k.length;p<x;f=++p)for(g=k[f],v=c=0,A=a.lines,e=z=0,m=A.length;z<m;e=++z){h=A[e];y=h.values[f];w=y+v;if(null==r||r>g)r=g;if(null==q||q<g)q=g;if(null==u||u>w)u=w;if(null==t||t<w)t=w;e=n[e];null!=h.baselineValues&&(c=h.baselineValues[f]);e.values[f]={x:g,y:y,yTranslation:v,areaY0:c,lineKey:h.label};b&&(v+=y)}return{labels:k,lines:n,xDomain:[r,q],yDomain:["log"===this.options.yScale?
