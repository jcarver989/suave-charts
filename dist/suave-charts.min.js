...
this.aspectRatio[1];this.width=b-a.left-a.right;this.height=d-a.bottom-a.top;this.container.attr("width",b).attr("height",d);return this.chart.attr("transform","translate("+a.left+","+a.top+")")};return c}();var defaultBarOptions$$module$target$coffeescript$defaults,defaultDonutOptions$$module$target$coffeescript$defaults,defaultLineOptions$$module$target$coffeescript$defaults,mergeOptions$$module$target$coffeescript$defaults;mergeOptions$$module$target$coffeescript$defaults=function(c,a){var d,b;b={};for(d in c)b[d]=c[d];for(d in a)b[d]=a[d];return b};
...
defaultBarOptions$$module$target$coffeescript$defaults={aspectRatio:"16:9",grid:!0,tooltips:!0,layout:"vertical",xLabelFormat:null,yLabelFormat:null,tooltipFormat:function(c){return d3.format(",.0f")(c)},barSpacing:.1,margin:{top:50,bottom:50,right:80,left:80}};defaultDonutOptions$$module$target$coffeescript$defaults={aspectRatio:"16:9",holeSize:.5,margin:{top:0,bottom:0,right:0,left:0}};
...
var module$target$coffeescript$abstract_chart=AbstractChart$$module$target$coffeescript$abstract_chart=function(){function c(a,d,b){null==d&&(d={});null==b&&(b={});this.options=defaults$$module$target$coffeescript$abstract_chart.mergeOptions(d,b);this.svg=new Svg$$module$target$coffeescript$abstract_chart(a,this.options.aspectRatio,this.options.margin);this.listenerBound=!1}c.prototype.draw=function(){if(!this.listenerBound)return window.addEventListener("resize",this.render),this.listenerBound=!0};
c.prototype.remove=function(){var a,d;window.removeEventListener("resize",this.render);a=this.svg.domElement;for(d=[];a.firstChild;)d.push(a.removeChild(a.firstChild));return d};return c}();var Axes$$module$target$coffeescript$axes,bind$$module$target$coffeescript$axes=function(c,a){return function(){return c.apply(a,arguments)}},module$target$coffeescript$axes=Axes$$module$target$coffeescript$axes=function(){function c(a,d,b,c){this.options=c;this.newAxis=bind$$module$target$coffeescript$axes(this.newAxis,this);this.xAxisSelection=a.append("g").attr("class","x axis");this.yAxisSelection=a.append("g").attr("class","y axis");this.xAxis=this.newAxis(d,"bottom");this.yAxis=this.newAxis(b,
"left")}c.prototype.draw=function(a,d){var b;this.xAxisSelection.attr("transform","translate(0,"+d+")");this.options.grid&&(this.xAxis.tickSize(-d),this.yAxis.tickSize(-a));this.options.xLabelInterval?(b=function(){switch(this.options.xLabelInterval){case "seconds":return d3.time.seconds;case "minutes":return d3.time.minutes;case "hours":return d3.time.hours;case "days":return d3.time.days;case "months":return d3.time.months;case "years":return d3.time.years}}.call(this),this.xAxis.ticks(b)):null!=
this.options.ticks&&0<this.options.ticks&&this.xAxis.ticks(this.options.ticks);this.xAxisSelection.call(this.xAxis);return this.yAxisSelection.call(this.yAxis)};c.prototype.newAxis=function(a,d){return d3.svg.axis().scale(a).orient(d).tickPadding(this.options.tickPadding)};return c}();var MarginCalculator$$module$target$coffeescript$margin_calculator,module$target$coffeescript$margin_calculator=MarginCalculator$$module$target$coffeescript$margin_calculator=function(){function c(a){this.svg=a}c.prototype.calcLeftMargin=function(a,d,b,c){var e;null==b&&(b="y");null==c&&(c=20);b=this.svg.chart.append("g").attr("class",b+" axis").attr("opacity",0);b.call(a);a=b.selectAll("text").sort(function(b,a){return a.length-b.length});d=1<=a.length&&1<=a[0].length?(e=a[0][0].getBBox(),Math.round(e.width)+
...
return{top:d.top-(b.bottom-b.top+10)+window.scrollY,left:a-(b.right-b.left)/2+window.scrollX}};return c}();var AbstractChart$$module$target$coffeescript$bar_chart,BarChart$$module$target$coffeescript$bar_chart,MarginCalculator$$module$target$coffeescript$bar_chart,Tooltip$$module$target$coffeescript$bar_chart,defaultBarOptions$$module$target$coffeescript$bar_chart,bind$$module$target$coffeescript$bar_chart=function(c,a){return function(){return c.apply(a,arguments)}},extend$$module$target$coffeescript$bar_chart=function(c,a){function d(){this.constructor=c}for(var b in a)hasProp$$module$target$coffeescript$bar_chart.call(a,
...
this.yAxis=d3.svg.axis().scale(this.y).tickFormat(this.options.yLabelFormat);"vertical"===this.options.layout?(this.xAxis.orient("bottom"),this.yAxis.orient("left")):(this.xAxis.orient("left"),this.yAxis.orient("bottom"))}extend$$module$target$coffeescript$bar_chart(a,c);a.prototype.render=function(){var a;this.svg.resize();a="vertical"===this.options.layout?(this.options.grid?this.yAxis.tickSize(-this.svg.width):void 0,{xTransform:"translate(0, "+this.svg.height+")",yTransform:"",groupsTransform:function(b){return function(a){return"translate("+
b.x(a)+", 0)"}}(this),xRange:[0,this.svg.width],yRange:[this.svg.height,0],barX:function(b){return function(a,d){return b.groupedX(d)}}(this),barY:function(a){return function(d){return a.y(d)}}(this),barWidth:function(a){return function(){return a.groupedX.rangeBand()}}(this),barHeight:function(a){return function(d){return a.svg.height-a.y(d)}}(this)}):(this.options.grid?this.yAxis.tickSize(-this.svg.height):void 0,{xTransform:"",yTransform:"translate(0, "+this.svg.height+")",groupsTransform:function(a){return function(d){return"translate(0, "+
a.x(d)+")"}}(this),xRange:[0,this.svg.height],yRange:[0,this.svg.width],barX:function(a){return function(a){return 0}}(this),barY:function(a){return function(d,c){return a.groupedX(c)}}(this),barHeight:function(a){return function(){return a.groupedX.rangeBand()}}(this),barWidth:function(a){return function(d){return a.y(d)}}(this)});this.x.rangeRoundBands(a.xRange,.1);this.groupedX.rangeRoundBands([0,this.x.rangeBand()],this.options.barSpacing);this.y.range(a.yRange);this.xAxisSelection.attr("transform",
a.xTransform).call(this.xAxis);this.yAxisSelection.attr("transform",a.yTransform).call(this.yAxis);this.groups.attr("transform",a.groupsTransform);return this.bars.attr("x",a.barX).attr("y",a.barY).attr("width",a.barWidth).attr("height",a.barHeight)};a.prototype.draw=function(d){var b,c,e,m;a.__super__.draw.call(this);c=function(){var a,c,e,f;e=d.bars;f=[];a=0;for(c=e.length;a<c;a++)b=e[a],f.push("[object Array]"===Object.prototype.toString.call(b)?b:[b]);return f}();this.y.domain([0,d3.max(d3.merge(c,
function(a){return d3.max(a)}))]);this.x.domain(d.labels);this.groupedX.domain(c[0].map(function(a,d){return d}));"vertical"===this.options.layout?this.options.margin.left=this.calc.calcLeftMargin(this.yAxis,this.options.margin.left):(this.x.rangeRoundBands([0,10],.1),this.options.margin.left=this.calc.calcLeftMargin(this.xAxis,this.options.margin.left,"x"));this.xAxisSelection=this.svg.chart.append("g").attr("class","x axis");this.yAxisSelection=this.svg.chart.append("g").attr("class","y axis");
this.groups=this.svg.chart.selectAll(".bar-group").data(d.labels).enter().append("g").attr("class",function(a){return"bar-group "+a});this.bars=this.groups.selectAll(".bar").data(function(a,d){return c[d]}).enter().append("rect").attr("class",function(a,d){return"bar bar-"+d});this.options.tooltips&&(m=this.options.tooltipFormat,e=this.tip||(this.tip=new Tooltip$$module$target$coffeescript$bar_chart(document)),this.bars.on("mouseover",function(a){e.html(m(a));return e.show(this)}),this.bars.on("mouseout",
...
a})}extend$$module$target$coffeescript$line_chart(a,c);a.prototype.enterLines=function(a){return a.append("path").attr("class",function(a){return"line "+a.label})};a.prototype.enterAreas=function(a){return a.filter(function(a){return!0===a.area}).append("path").attr("class",function(a){return"area "+a.label})};a.prototype.createTooltip=function(){var a,b;b=this.tip||(this.tip=new Tooltip$$module$target$coffeescript$line_chart(document));a=this.options.tooltipFormat;this.dots.on("mouseover",function(c){b.html(a(c.y));
return b.show(this)});return this.dots.on("mouseout",function(a){return b.hide()})};a.prototype.render=function(){this.svg.resize();this.x.range([0,this.svg.width]);this.y.range([this.svg.height,0]);this.axes.draw(this.svg.width,this.svg.height);this.lines.attr("d",function(a){return function(b){a.line.interpolate(a.chooseInterpolation(b));return a.line(b.values)}}(this));this.area.y0(this.svg.height);this.areas.attr("d",function(a){return function(b){a.area.interpolate(a.chooseInterpolation(b));
return a.area(b.values)}}(this));return this.dots.attr("cx",function(a){return function(b){return a.x(b.x)}}(this)).attr("cy",function(a){return function(b){return a.y(b.y)}}(this))};a.prototype.chooseInterpolation=function(a){return a.smooth?"monotone":"linear"};a.prototype.draw=function(d){var b,c;a.__super__.draw.call(this);this.xLabels=this.isTimeSeries&&"number"===typeof d.labels[0]?d.labels.map(function(a){return new Date(a)}):d.labels;c=d3.merge(function(){var a,c,g,h;g=d.lines;h=[];a=0;for(c=
g.length;a<c;a++)b=g[a],h.push(b.values);return h}());this.x.domain(d3.extent(this.xLabels,function(a){return a})).nice();this.y.domain([0,d3.max(c,function(a){return a})]).nice();this.line.x(function(a){return function(b,c){return a.x(a.xLabels[c])}}(this)).y(function(a){return function(b){return a.y(b)}}(this));this.area.x(function(a){return function(b,c){return a.x(a.xLabels[c])}}(this)).y(function(a){return function(b){return a.y(b)}}(this));this.options.autoMargins&&(this.options.margin.left=
this.calc.calcLeftMargin(this.axes.yAxis,this.options.margin.left));this.lineGroups=this.svg.chart.selectAll(".lineGroup").data(d.lines,function(a){return a.label});c=this.lineGroups.enter().append("g").attr("class","lineGroup");this.enterLines(c);this.enterAreas(c);this.lines=this.lineGroups.selectAll(".line");this.areas=this.lineGroups.selectAll(".area");this.dotGroups=this.svg.chart.selectAll(".dotGroup").data(d.lines,function(a){return a.label});this.dotGroups.enter().append("g").attr("class",
