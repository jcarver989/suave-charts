...
function(c){return document.body.contains(this.svg.container[0][0])?c():setTimeout(function(b){return function(){return b.waitToBeInDom(c)}}(this),10)};d.prototype.draw=function(){if(!this.listenerBound)return window.addEventListener("resize",this.render),this.listenerBound=!0};d.prototype.remove=function(){var c,b;window.removeEventListener("resize",this.render);null!=this.tip&&this.tip.remove();c=this.svg.domElement;for(b=[];c.firstChild;)b.push(c.removeChild(c.firstChild));return b};return d}();var filterTicks$$module$target$coffeescript$filter_ticks,module$target$coffeescript$filter_ticks=filterTicks$$module$target$coffeescript$filter_ticks=function(d,c,b){var a,h;return"ordinal"===b?(a=c.domain(),h=Math.round(a.length/(d-2)),a.filter(function(b,c){return 0===c||b===a[a.length-1]?!0:0===c%h})):c.ticks(d)};var Axes$$module$target$coffeescript$axes,filterTicks$$module$target$coffeescript$axes,bind$$module$target$coffeescript$axes=function(d,c){return function(){return d.apply(c,arguments)}};filterTicks$$module$target$coffeescript$axes=module$target$coffeescript$filter_ticks;
var module$target$coffeescript$axes=Axes$$module$target$coffeescript$axes=function(){function d(c,b,a,d,n){this.xScale=b;this.yScale=a;this.options=d;this.axisLabelPadding=n;this.newAxis=bind$$module$target$coffeescript$axes(this.newAxis,this);this.xAxisSelection=c.append("g").attr("class","x axis");this.yAxisSelection=c.append("g").attr("class","y axis");this.xAxis=this.newAxis(this.xScale,"bottom");this.yAxis=this.newAxis(this.yScale,"left")}d.prototype.draw=function(c,b){var a,d;this.xAxisSelection.attr("transform",
...
0<this.options.ticks&&(d=filterTicks$$module$target$coffeescript$axes(this.options.ticks,this.xScale,this.options.xScale),this.xAxis.tickValues(d));this.yAxis.ticks(this.options.yTicks);this.xAxisSelection.call(this.xAxis);return this.yAxisSelection.call(this.yAxis)};d.prototype.newAxis=function(c,b){return d3.svg.axis().scale(c).orient(b).tickPadding(this.axisLabelPadding)};return d}();var MarginCalculator$$module$target$coffeescript$margin_calculator,module$target$coffeescript$margin_calculator=MarginCalculator$$module$target$coffeescript$margin_calculator=function(){function d(c){this.svg=c}d.prototype.calcLeftMargin=function(c,b,a,d){var n;null==a&&(a="y");null==d&&(d=20);a=this.svg.chart.append("g").attr("class",a+" axis").attr("opacity",0);a.call(c);c=a.selectAll("text").sort(function(a,b){return b.toString().length-a.toString().length});b=1<=c.length&&1<=c[0].length?(n=c[0][0].getBBox(),
Math.round(n.width)+d):b;a.remove();return b};return d}();var Tooltip$$module$target$coffeescript$tooltip,bind$$module$target$coffeescript$tooltip=function(d,c){return function(){return d.apply(c,arguments)}},module$target$coffeescript$tooltip=Tooltip$$module$target$coffeescript$tooltip=function(){function d(c){this.remove=bind$$module$target$coffeescript$tooltip(this.remove,this);this.hide=bind$$module$target$coffeescript$tooltip(this.hide,this);this.show=bind$$module$target$coffeescript$tooltip(this.show,this);this.html=bind$$module$target$coffeescript$tooltip(this.html,
this);var b;this.cssClass="suave-tooltip";b=c.querySelector("."+this.cssClass)||c.createElement("div");this.tip=d3.select(b);this.tip.attr("class",this.cssClass);c.body.appendChild(this.tip.node())}d.prototype.html=function(c){return this.tip.html(c)};d.prototype.show=function(c){c=this.offset(c);this.tip.attr("class",this.cssClass+" show");return this.tip.style({position:"absolute",top:c.top+"px",left:c.left+"px"})};d.prototype.hide=function(){return this.tip.attr("class",this.cssClass)};d.prototype.remove=
function(){return this.tip.remove()};d.prototype.offset=function(c){var b,a;b=c.getBoundingClientRect();c=b.left+(b.right-b.left)/2;a=this.tip.node().getBoundingClientRect();return{top:b.top-(a.bottom-a.top+10)+window.scrollY,left:c-(a.right-a.left)/2+window.scrollX}};return d}();var AbstractChart$$module$target$coffeescript$bar_chart,BarChart$$module$target$coffeescript$bar_chart,MarginCalculator$$module$target$coffeescript$bar_chart,Tooltip$$module$target$coffeescript$bar_chart,defaultBarOptions$$module$target$coffeescript$bar_chart,filterTicks$$module$target$coffeescript$bar_chart,bind$$module$target$coffeescript$bar_chart=function(d,c){return function(){return d.apply(c,arguments)}},extend$$module$target$coffeescript$bar_chart=function(d,c){function b(){this.constructor=
...
function(){var b,a,c,d,e,f,k,l,m,g;this.svg.resize();this.x.rangeRoundBands([0,this.svg.width]);this.options.grid&&this.yAxis.tickSize(-this.svg.width,0);a={xTransform:"translate(0, "+this.svg.height+")",yTransform:"",groupsTransform:function(a){return function(b){return"translate("+a.x(b)+", 0)"}}(this),xRange:[0,this.svg.width],yRange:[this.svg.height,0],barX:function(a){return function(b){return a.x(b.label)}}(this),barY:function(a){return function(b){return a.y(b.value)}}(this),barWidth:function(a){return function(){return a.x.rangeBand()}}(this),
barHeight:function(a){return function(b){return a.svg.height-a.y(b.value)}}(this)};this.x.rangeRoundBands(a.xRange,this.options.barSpacing);this.y.range(a.yRange);this.xAxisSelection.attr("transform",a.xTransform).call(this.xAxis).selectAll(".tick text").call(this.wrap,a.barWidth());this.yAxisSelection.attr("transform",a.yTransform).call(this.yAxis);this.bars.attr("x",a.barX).attr("y",a.barY).attr("width",a.barWidth).attr("height",a.barHeight);this.totalBar.attr("x",a.barX).attr("y",a.barY).attr("width",
a.barWidth).attr("height",a.barHeight);this.totalBarBackground.attr("x",a.barX).attr("y",0).attr("width",a.barWidth).attr("height",this.y.range()[0]);b=function(b){return function(b){return a.barX(b)+.5*a.barWidth()}}(this);f=function(b){return function(c){return Math.min(a.barY(c)-b.tipPadding,b.svg.height-b.tipPadding)}}(this);this.tooltips.attr("x",b).attr("y",f);this.labels.attr("x",b).attr("y",f).attr("dy","-1.5em").text(function(a){return function(b){return a.options.tooltipFormat(b.value)}}(this));
this.subLabels.attr("class","sub-label").attr("x",b).attr("y",f).attr("dy","0em").text(function(a){return function(a){return a.tooltipLabel}}(this));this.totalBarTooltip.attr("x",function(b){return function(b){return a.barX(b)+.5*a.barWidth()}}(this)).attr("y",function(b){return function(c){return Math.min(a.barY(c)-b.tipPadding,b.svg.height-b.tipPadding)}}(this)).text(function(a){return function(b){return a.options.tooltipFormat(b.value)}}(this));l=this.totalBar;m=this.totalBarTooltip;g=this.y;d=
this.sum;k=this.options.tooltipFormat;e=this.tipPadding;c=this.onChangeCallback;b=d3.behavior.drag();b.on("drag",function(b){var c,h;c=d();c=Math.min(Math.round(g.invert(d3.event.y)-b.value),c);c=Math.max(0,Math.min(b.value+c,g.domain()[1]));b.value=c;d3.select(this).selectAll("circle").attr("cy",g(c));b=d3.select(this.parentNode);b.select("rect").attr("height",a.barHeight({value:c})).attr("y",a.barY({value:c}));b.select("text").attr("y",function(b){return a.barY(b)-e}).attr("dy","-1.5em").text(k(c));
h=d();l.each(function(a){return a.value=h});l.attr("height",a.barHeight({value:h})).attr("y",a.barY({value:h}));return m.attr("y",a.barY({value:h})-e).text(k(h))});b.on("dragend",function(a){if(null!=c)return c({label:a.label,value:a.value,remaining:d()})});this.dots.attr("cx",function(b){return function(b){return a.barX(b)+.5*a.barWidth()}}(this)).attr("cy",function(b){return function(b){return a.barY(b)}}(this)).attr("class","drag-handle");this.innerDots.attr("cx",function(b){return function(b){return a.barX(b)+
.5*a.barWidth()}}(this)).attr("cy",function(b){return function(b){return a.barY(b)}}(this)).attr("class","drag-handle-inner");return this.dotGroups.call(b)};c.prototype.wrap=function(b,a){return b.each(function(){var a,c,d;b=d3.select(this);d=b.attr("y");a=parseFloat(b.attr("dy"));a=parseFloat(b.attr("dy"));c=b.text().split(/([0-9]+ year.*)/);b.text(null);return c.forEach(function(c,n){return b.append("tspan").attr("x",0).attr("y",d).attr("dy",1.5*n+a+"em").text(c)})})};c.prototype.draw=function(b){c.__super__.draw.call(this);
this.onChangeCallback=b.onChangeCallback;return this.waitToBeInDom(function(a){return function(){return a.drawInternal(b)}}(this))};c.prototype.drawInternal=function(b){var a,c,d,e;d=b.bars.reduce(function(b,a){return b+a},0);a=[{value:d,label:b.domainLabel}];e=null!=b.tooltipLabels?b.tooltipLabels:function(){var a,c,d;c=b.labels;d=[];a=0;for(c=c.length;a<c;a++)d.push("");return d}();b.bars.forEach(function(c,d){return a.push({value:c,label:b.labels[d],tooltipLabel:e[d]})});c=b.domain;this.y.domain([c[0],
Math.max(d,c[1])]);this.x.domain(a.map(function(a){return a.label}));this.options.margin.left=this.calc.calcLeftMargin(this.yAxis,this.options.margin.left);this.xAxisSelection=this.svg.chart.append("g").attr("class","x axis");this.yAxisSelection=this.svg.chart.append("g").attr("class","y axis");this.groups=this.svg.chart.selectAll(".barGroup").data(a).enter().append("g").attr("class",function(a,b){return"barGroup barGroup-"+b+" "+a.label});this.barGroups=this.groups.append("g").attr("class",function(a,
b){return"bar bar-"+b});this.barGroupsWithoutTotal=this.barGroups.filter(function(a,b){return 0!==b});this.bars=this.barGroupsWithoutTotal.append("rect");this.dotGroups=this.barGroupsWithoutTotal.append("g").attr("class","drag-handle-group");this.dots=this.dotGroups.append("circle").attr("r",this.options.dotSize);this.innerDots=this.dotGroups.append("circle").attr("r",this.options.dotSize/2);this.tooltips=this.barGroupsWithoutTotal.append("text").attr("text-anchor","middle");this.labels=this.tooltips.append("tspan");
this.subLabels=this.tooltips.append("tspan");this.totalBarGroup=this.barGroups.filter(function(a,b){return 0===b}).datum({value:this.sum(),label:b.domainLabel}).append("g").attr("class","total");this.totalBarBackground=this.totalBarGroup.append("rect").attr("class","background");this.totalBar=this.totalBarGroup.append("rect").attr("class","sum");this.totalBarTooltip=this.totalBarGroup.append("text").attr("text-anchor","middle");return this.render()};return c}(AbstractChart$$module$target$coffeescript$goals_chart);var AbstractChart$$module$target$coffeescript$histogram,Histogram$$module$target$coffeescript$histogram,MarginCalculator$$module$target$coffeescript$histogram,Tooltip$$module$target$coffeescript$histogram,defaultHistogramOptions$$module$target$coffeescript$histogram,bind$$module$target$coffeescript$histogram=function(d,c){return function(){return d.apply(c,arguments)}},extend$$module$target$coffeescript$histogram=function(d,c){function b(){this.constructor=d}for(var a in c)hasProp$$module$target$coffeescript$histogram.call(c,
...
return b.area(a.values)}}(this));return this.dots.attr("cx",function(b){return function(a){return b.x(a.x)}}(this)).attr("cy",function(b){return function(a){return b.y(a.y+a.yTranslation)}}(this))};c.prototype.chooseInterpolation=function(b){return b.smooth?"monotone":"linear"};c.prototype.formatData=function(b,a){var c,d,e,f,k,l,m,g,p,q,z,A,r,t,y,u,v,w,x;null==a&&(a=!1);k=this.isTimeSeries&&"number"===typeof b.labels[0]?b.labels.map(function(a){return new Date(a)}):b.labels;v=u=r=t=null;p=[];m=b.lines;
e=c=0;for(l=m.length;c<l;e=++c)for(f in g=m[e],p.push({values:Array(g.values.length)}),g)q=g[f],"values"!==f&&(p[e][f]=q);e=q=0;for(l=k.length;q<l;e=++q)for(f=k[e],w=c=0,A=b.lines,d=z=0,m=A.length;z<m;d=++z){g=A[d];y=g.values[e];x=y+w;if(null==t||t>f)t=f;if(null==r||r<f)r=f;if(null==v||v>x)v=x;if(null==u||u<x)u=x;d=p[d];null!=g.baselineValues&&(c=g.baselineValues[e]);d.values[e]={x:f,y:y,yTranslation:w,areaY0:c,lineKey:g.label};a&&(w+=y)}return{labels:k,lines:p,xDomain:[t,r],yDomain:["log"===this.options.yScale?
