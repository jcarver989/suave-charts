...
defaultLineOptions$$module$target$coffeescript$defaults={autoMargins:!0,aspectRatio:"16:9",dotSize:6,grid:!0,xScale:"ordinal",yScale:"linear",smoothLines:!1,stack:!1,tooltips:!0,xLabelFormat:null,yLabelFormat:null,tooltipFormat:function(d){return d3.format(",.0f")(d)},ticks:10,margin:{top:50,bottom:50,right:80,left:80}};
...
Math.round(f.width)+d):b;a.remove();return b};return d}();var Tooltip$$module$target$coffeescript$tooltip,bind$$module$target$coffeescript$tooltip=function(d,c){return function(){return d.apply(c,arguments)}},module$target$coffeescript$tooltip=Tooltip$$module$target$coffeescript$tooltip=function(){function d(c){this.remove=bind$$module$target$coffeescript$tooltip(this.remove,this);this.hide=bind$$module$target$coffeescript$tooltip(this.hide,this);this.show=bind$$module$target$coffeescript$tooltip(this.show,this);this.html=bind$$module$target$coffeescript$tooltip(this.html,
