...
return b}();var BarChart,bind=function(b,a){return function(){return b.apply(a,arguments)}},extend=function(b,a){function d(){this.constructor=b}for(var c in a)hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b},hasProp={}.hasOwnProperty;
...
0]);this.xAxisSelection.attr("transform","translate(0, "+this.svg.height+")").call(this.xAxis);this.yAxisSelection.call(this.yAxis);return this.bars.attr("x",function(d){return function(a){return d.x(a[0])}}(this)).attr("y",function(a){return function(c){return a.y(c[1])}}(this)).attr("width",this.x.rangeBand()).attr("height",function(a){return function(c){return a.svg.height-a.y(c[1])}}(this))};a.prototype.draw=function(a){var c;this.x.domain(a.map(function(a){return a[0]}));this.y.domain([0,d3.max(a,
...
return this.render()};return a}(AbstractChart);var defaultBarOptions,defaultDonutOptions,defaultLineOptions,mergeOptions;mergeOptions=function(b,a){var d,c;c={};for(d in b)c[d]=b[d];for(d in a)c[d]=a[d];return c};defaultLineOptions={xScale:"linear",yScale:"linear",smoothLines:!1,tooltips:!0,aspectRatio:"16:9",tickPadding:10,dotSize:6,grid:!0,autoMargins:!0,margin:{top:50,bottom:50,right:80,left:80}};defaultBarOptions={aspectRatio:"16:9",margin:{top:50,bottom:50,right:80,left:80}};
...
LineChart=function(b){function a(d,c){null==c&&(c={});this.render=bind(this.render,this);a.__super__.constructor.call(this,d,defaultLineOptions,c);this.x=Scales.fromString(this.options.xScale);this.y=Scales.fromString(this.options.yScale);this.axes=new Axes(this.svg.chart,this.x,this.y,this.options);this.calc=new MarginCalculator(this.svg);this.line=d3.svg.line();this.area=d3.svg.area();window.addEventListener("resize",this.render)}extend(a,b);a.prototype.enterLines=function(a){return a.append("path").attr("class",
function(a){return"line "+a.label})};a.prototype.enterAreas=function(a){return a.filter(function(a){return!0===a.area}).append("path").attr("class",function(a){return"area "+a.label})};a.prototype.createTooltip=function(){var a;a=this.tip||(this.tip=new Tooltip(document));this.dots.on("mouseover",function(c){a.html(c.value);return a.show(this)});return this.dots.on("mouseout",function(c){return a.hide()})};a.prototype.render=function(){this.svg.resize();this.x.range([0,this.svg.width]);this.y.range([this.svg.height,
0]);this.axes.draw(this.svg.width,this.svg.height);this.lines.attr("d",function(a){return function(c){a.line.interpolate(a.chooseInterpolation(c));return a.line(c.values)}}(this));this.area.y0(this.svg.height);this.areas.attr("d",function(a){return function(c){a.area.interpolate(a.chooseInterpolation(c));return a.area(c.values)}}(this));return this.dots.attr("cx",function(a){return function(c,b){return a.x(a.xLabels[b])}}(this)).attr("cy",function(a){return function(c,b){return a.y(c.value)}}(this))};
a.prototype.chooseInterpolation=function(a){return a.smooth?"monotone":"linear"};a.prototype.draw=function(a){var c,b;this.xLabels=a.labels;b=d3.merge(function(){var b,k,g,h;g=a.lines;h=[];b=0;for(k=g.length;b<k;b++)c=g[b],h.push(c.values);return h}());this.x.domain(d3.extent(this.xLabels,function(a){return a})).nice();this.y.domain([0,d3.max(b,function(a){return a})]).nice();this.line.x(function(a){return function(c,b){return a.x(a.xLabels[b])}}(this)).y(function(a){return function(c){return a.y(c)}}(this));
this.area.x(function(a){return function(c,b){return a.x(a.xLabels[b])}}(this)).y(function(a){return function(c){return a.y(c)}}(this));this.options.autoMargins&&(this.options.margin.left=this.calc.calcLeftMargin(this.axes.yAxis,this.options.margin.left));this.lineGroups=this.svg.chart.selectAll(".lineGroup").data(a.lines,function(a){return a.label});b=this.lineGroups.enter().append("g").attr("class","lineGroup");this.enterLines(b);this.enterAreas(b);this.lines=this.lineGroups.selectAll(".line");this.areas=
this.lineGroups.selectAll(".area");this.dotGroups=this.svg.chart.selectAll(".dotGroup").data(a.lines,function(a){return a.label});this.dotGroups.enter().append("g").attr("class","dotGroup");this.dots=this.dotGroups.selectAll(".dot").data(function(a){var c,b,d,e,l;if(!1===a.dots)return[];d=a.values;e=[];c=0;for(b=d.length;c<b;c++)l=d[c],e.push({value:l,label:a.label});return e});this.dots.enter().append("circle").attr("class",function(a){return"dot "+a.label}).attr("r",this.options.dotSize);this.options.tooltips&&
