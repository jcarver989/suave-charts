...
var module$target$coffeescript$defaults={mergeOptions:mergeOptions$$module$target$coffeescript$defaults,lineOptions:defaultLineOptions$$module$target$coffeescript$defaults,barOptions:defaultBarOptions$$module$target$coffeescript$defaults,histogramOptions:defaultHistogramOptions$$module$target$coffeescript$defaults,donutOptions:defaultDonutOptions$$module$target$coffeescript$defaults};var AbstractChart$$module$target$coffeescript$abstract_chart,Svg$$module$target$coffeescript$abstract_chart,defaults$$module$target$coffeescript$abstract_chart,bind$$module$target$coffeescript$abstract_chart=function(d,c){return function(){return d.apply(c,arguments)}};defaults$$module$target$coffeescript$abstract_chart=module$target$coffeescript$defaults;Svg$$module$target$coffeescript$abstract_chart=module$target$coffeescript$svg;
var module$target$coffeescript$abstract_chart=AbstractChart$$module$target$coffeescript$abstract_chart=function(){function d(c,b,a){null==b&&(b={});null==a&&(a={});this.waitToBeInDom=bind$$module$target$coffeescript$abstract_chart(this.waitToBeInDom,this);this.options=defaults$$module$target$coffeescript$abstract_chart.mergeOptions(b,a);this.svg=new Svg$$module$target$coffeescript$abstract_chart(c,this.options.aspectRatio,this.options.margin);this.listenerBound=!1;this.axisLabelPadding=10}d.prototype.waitToBeInDom=
function(c){return document.body.contains(this.svg.container[0][0])?c():setTimeout(function(b){return function(){return b.waitToBeInDom(c)}}(this),10)};d.prototype.draw=function(){if(!this.listenerBound)return window.addEventListener("resize",this.render),this.listenerBound=!0};d.prototype.remove=function(){var c,b;window.removeEventListener("resize",this.render);null!=this.tip&&this.tip.remove();c=this.svg.domElement;for(b=[];c.firstChild;)b.push(c.removeChild(c.firstChild));return b};return d}();var filterTicks$$module$target$coffeescript$filter_ticks,module$target$coffeescript$filter_ticks=filterTicks$$module$target$coffeescript$filter_ticks=function(d,c,b){var a,e;return"ordinal"===b?(a=c.domain(),e=Math.round(a.length/(d-2)),a.filter(function(b,c){return 0===c||b===a[a.length-1]?!0:0===c%e})):c.ticks(d)};var Axes$$module$target$coffeescript$axes,filterTicks$$module$target$coffeescript$axes,bind$$module$target$coffeescript$axes=function(d,c){return function(){return d.apply(c,arguments)}};filterTicks$$module$target$coffeescript$axes=module$target$coffeescript$filter_ticks;
var module$target$coffeescript$axes=Axes$$module$target$coffeescript$axes=function(){function d(c,b,a,e,d){this.xScale=b;this.yScale=a;this.options=e;this.axisLabelPadding=d;this.newAxis=bind$$module$target$coffeescript$axes(this.newAxis,this);this.xAxisSelection=c.append("g").attr("class","x axis");this.yAxisSelection=c.append("g").attr("class","y axis");this.xAxis=this.newAxis(this.xScale,"bottom");this.yAxis=this.newAxis(this.yScale,"left")}d.prototype.draw=function(c,b){var a,e;this.xAxisSelection.attr("transform",
"translate(0,"+b+")");this.options.grid&&(this.xAxis.tickSize(-b,0),this.yAxis.tickSize(-c,0));this.options.xLabelInterval?(e=function(){switch(this.options.xLabelInterval){case "seconds":return d3.time.seconds;case "minutes":return d3.time.minutes;case "hours":return d3.time.hours;case "days":return d3.time.days;case "months":return d3.time.months;case "years":return d3.time.years}}.call(this),a=null!=this.options.tickStepSize?this.options.tickStepSize:1,this.xAxis.ticks(e,a)):null!=this.options.ticks&&
0<this.options.ticks&&(e=filterTicks$$module$target$coffeescript$axes(this.options.ticks,this.xScale,this.options.xScale),this.xAxis.tickValues(e));this.yAxis.ticks(this.options.yTicks);this.xAxisSelection.call(this.xAxis);return this.yAxisSelection.call(this.yAxis)};d.prototype.newAxis=function(c,b){return d3.svg.axis().scale(c).orient(b).tickPadding(this.axisLabelPadding)};return d}();var MarginCalculator$$module$target$coffeescript$margin_calculator,module$target$coffeescript$margin_calculator=MarginCalculator$$module$target$coffeescript$margin_calculator=function(){function d(c){this.svg=c}d.prototype.calcLeftMargin=function(c,b,a,e){var d;null==a&&(a="y");null==e&&(e=20);a=this.svg.chart.append("g").attr("class",a+" axis").attr("opacity",0);a.call(c);c=a.selectAll("text").sort(function(a,b){return b.toString().length-a.toString().length});b=1<=c.length&&1<=c[0].length?(d=c[0][0].getBBox(),
Math.round(d.width)+e):b;a.remove();return b};return d}();var Tooltip$$module$target$coffeescript$tooltip,bind$$module$target$coffeescript$tooltip=function(d,c){return function(){return d.apply(c,arguments)}},module$target$coffeescript$tooltip=Tooltip$$module$target$coffeescript$tooltip=function(){function d(c){this.remove=bind$$module$target$coffeescript$tooltip(this.remove,this);this.hide=bind$$module$target$coffeescript$tooltip(this.hide,this);this.show=bind$$module$target$coffeescript$tooltip(this.show,this);this.html=bind$$module$target$coffeescript$tooltip(this.html,
...
")",yTransform:"",groupsTransform:function(a){return function(b){return"translate("+a.x(b)+", 0)"}}(this),xRange:[0,this.svg.width],yRange:[this.svg.height,0],barX:function(a){return function(b,c){return a.groupedX(c)}}(this),barY:function(a){return function(b){return a.y(b)}}(this),barWidth:function(a){return function(){return a.groupedX.rangeBand()}}(this),barHeight:function(a){return function(b){return a.svg.height-a.y(b)}}(this)}):(this.options.grid?this.yAxis.tickSize(-this.svg.height,0):void 0,
{xTransform:"",yTransform:"translate(0, "+this.svg.height+")",groupsTransform:function(a){return function(b){return"translate(0, "+a.x(b)+")"}}(this),xRange:[0,this.svg.height],yRange:[0,this.svg.width],barX:function(a){return function(a){return 0}}(this),barY:function(a){return function(b,c){return a.groupedX(c)}}(this),barHeight:function(a){return function(){return a.groupedX.rangeBand()}}(this),barWidth:function(a){return function(b){return a.y(b)}}(this)});this.x.rangeRoundBands(b.xRange,.1);
this.groupedX.rangeRoundBands([0,this.x.rangeBand()],this.options.barSpacing);this.y.range(b.yRange);this.xAxisSelection.attr("transform",b.xTransform).call(this.xAxis);this.yAxisSelection.attr("transform",b.yTransform).call(this.yAxis);this.groups.attr("transform",b.groupsTransform);return this.bars.attr("x",b.barX).attr("y",b.barY).attr("width",b.barWidth).attr("height",b.barHeight)};c.prototype.draw=function(b){c.__super__.draw.call(this);return this.waitToBeInDom(function(a){return function(){return a.drawInternal(b)}}(this))};
c.prototype.drawInternal=function(b){var a,c,d,f;c=function(){var c,d,e,n;e=b.bars;n=[];c=0;for(d=e.length;c<d;c++)a=e[c],n.push("[object Array]"===Object.prototype.toString.call(a)?a:[a]);return n}();this.y.domain([0,d3.max(d3.merge(c,function(a){return d3.max(a)}))]);this.x.domain(b.labels);this.groupedX.domain(c[0].map(function(a,b){return b}));null!=this.options.ticks&&0<this.options.ticks&&this.xAxis.tickValues(filterTicks$$module$target$coffeescript$bar_chart(this.options.ticks,this.x,"ordinal"));
"vertical"===this.options.layout?this.options.margin.left=this.calc.calcLeftMargin(this.yAxis,this.options.margin.left):(this.x.rangeRoundBands([0,10],.1),this.options.margin.left=this.calc.calcLeftMargin(this.xAxis,this.options.margin.left,"x"));this.xAxisSelection=this.svg.chart.append("g").attr("class","x axis");this.yAxisSelection=this.svg.chart.append("g").attr("class","y axis");this.groups=this.svg.chart.selectAll(".barGroup").data(b.labels).enter().append("g").attr("class",function(a,b){return"barGroup barGroup-"+
b+" "+a});this.bars=this.groups.selectAll(".bar").data(function(a,b){return c[b]}).enter().append("rect").attr("class",function(a,b){return"bar bar-"+b});this.options.tooltips&&(f=this.options.tooltipFormat,d=this.tip||(this.tip=new Tooltip$$module$target$coffeescript$bar_chart(document)),this.bars.on("mouseover",function(a){d.html(f(a));return d.show(this)}),this.bars.on("mouseout",function(a){return d.hide()}));return this.render()};return c}(AbstractChart$$module$target$coffeescript$bar_chart);var AbstractChart$$module$target$coffeescript$donut_chart,DonutChart$$module$target$coffeescript$donut_chart,defaultDonutOptions$$module$target$coffeescript$donut_chart,bind$$module$target$coffeescript$donut_chart=function(d,c){return function(){return d.apply(c,arguments)}},extend$$module$target$coffeescript$donut_chart=function(d,c){function b(){this.constructor=d}for(var a in c)hasProp$$module$target$coffeescript$donut_chart.call(c,a)&&(d[a]=c[a]);b.prototype=c.prototype;d.prototype=new b;d.__super__=
...
this.xAxis=d3.svg.axis().scale(this.x).tickFormat(this.options.xLabelFormat).outerTickSize(0).tickPadding(this.axisLabelPadding);this.yAxis=d3.svg.axis().scale(this.y).tickFormat(this.options.yLabelFormat).tickPadding(this.axisLabelPadding).ticks(5);this.xAxis.orient("bottom");this.yAxis.orient("left");this.tipPadding=20}extend$$module$target$coffeescript$goals_chart(c,d);c.prototype.sum=function(){var b;b=this.y.domain()[1];this.bars.each(function(a){return b-=a.value});return b};c.prototype.render=
function(){var b,a,c,d,f,g,h,m,k;this.svg.resize();this.x.rangeRoundBands([0,this.svg.width]);this.options.grid&&this.yAxis.tickSize(-this.svg.width,0);a={xTransform:"translate(0, "+this.svg.height+")",yTransform:"",groupsTransform:function(a){return function(b){return"translate("+a.x(b)+", 0)"}}(this),xRange:[0,this.svg.width],yRange:[this.svg.height,0],barX:function(a){return function(b){return a.x(b.label)}}(this),barY:function(a){return function(b){return a.y(b.value)}}(this),barWidth:function(a){return function(){return a.x.rangeBand()}}(this),
barHeight:function(a){return function(b){return a.svg.height-a.y(b.value)}}(this)};this.x.rangeRoundBands(a.xRange,this.options.barSpacing);this.y.range(a.yRange);this.xAxisSelection.attr("transform",a.xTransform).call(this.xAxis).selectAll(".tick text").call(this.wrap2,a.barWidth());this.yAxisSelection.attr("transform",a.yTransform).call(this.yAxis);this.bars.attr("x",a.barX).attr("y",a.barY).attr("width",a.barWidth).attr("height",a.barHeight);this.totalBar.attr("x",a.barX).attr("y",a.barY).attr("width",
a.barWidth).attr("height",a.barHeight);this.totalBarBackground.attr("x",a.barX).attr("y",0).attr("width",a.barWidth).attr("height",this.y.range()[0]);this.tooltips.attr("x",function(b){return function(b){return a.barX(b)+.5*a.barWidth()}}(this)).attr("y",function(b){return function(c){return Math.min(a.barY(c)-b.tipPadding,b.svg.height-b.tipPadding)}}(this)).text(function(a){return function(b){return a.options.tooltipFormat(b.value)}}(this));this.totalBarTooltip.attr("x",function(b){return function(b){return a.barX(b)+
.5*a.barWidth()}}(this)).attr("y",function(b){return function(c){return Math.min(a.barY(c)-b.tipPadding,b.svg.height-b.tipPadding)}}(this)).text(function(a){return function(b){return a.options.tooltipFormat(b.value)}}(this));h=this.totalBar;m=this.totalBarTooltip;k=this.y;d=this.sum;g=this.options.tooltipFormat;f=this.tipPadding;c=this.onChangeCallback;b=d3.behavior.drag();b.on("drag",function(b){var c,e;c=d();c=Math.min(Math.round(k.invert(d3.event.y)-b.value),c);c=Math.max(0,Math.min(b.value+c,
k.domain()[1]));b.value=c;d3.select(this).selectAll("circle").attr("cy",k(c));b=d3.select(this.parentNode);b.select("rect").attr("height",a.barHeight({value:c})).attr("y",a.barY({value:c}));b.select("text").attr("y",function(b){return a.barY(b)-f}).text(g(c));e=d();h.each(function(a){return a.value=e});h.attr("height",a.barHeight({value:e})).attr("y",a.barY({value:e}));return m.attr("y",a.barY({value:e})-f).text(g(e))});b.on("dragend",function(a){if(null!=c)return c({label:a.label,value:a.value,remaining:d()})});
this.dots.attr("cx",function(b){return function(b){return a.barX(b)+.5*a.barWidth()}}(this)).attr("cy",function(b){return function(b){return a.barY(b)}}(this)).attr("class","drag-handle");this.innerDots.attr("cx",function(b){return function(b){return a.barX(b)+.5*a.barWidth()}}(this)).attr("cy",function(b){return function(b){return a.barY(b)}}(this)).attr("class","drag-handle-inner");return this.dotGroups.call(b)};c.prototype.wrap2=function(b,a){return b.each(function(){var a,c,d;b=d3.select(this);
d=b.attr("y");a=parseFloat(b.attr("dy"));a=parseFloat(b.attr("dy"));c=b.text().split(/([0-9]+ year.*)/);b.text(null);return c.forEach(function(c,n){return b.append("tspan").attr("x",0).attr("y",d).attr("dy",1.5*n+a+"em").text(c)})})};c.prototype.wrap=function(b,a){return b.each(function(){var c,d,f,g,h,m,k,l;b=d3.select(this);k=b.text().split(/\s+/).reverse();d=[];f=0;l=b.attr("y");c=parseFloat(b.attr("dy"));h=b.text(null).append("tspan").attr("x",0).attr("y",l).attr("dy",c+"em");for(g=[];m=k.pop();)d.push(m),
h.text(d.join(" ")),h.node().getComputedTextLength()>a?(d.pop(),h.text(d.join(" ")),d=[m],g.push(h=b.append("tspan").attr("x",0).attr("y",l).attr("dy",1.1*++f+c+"em").text(m))):g.push(void 0);return g})};c.prototype.draw=function(b){c.__super__.draw.call(this);this.onChangeCallback=b.onChangeCallback;return this.waitToBeInDom(function(a){return function(){return a.drawInternal(b)}}(this))};c.prototype.drawInternal=function(b){var a;a=[{value:b.bars.reduce(function(a,b){return a+b},0),label:b.domainLabel}];
b.bars.forEach(function(c,d){return a.push({value:c,label:b.labels[d]})});this.y.domain(b.domain);this.x.domain(a.map(function(a){return a.label}));this.options.margin.left=this.calc.calcLeftMargin(this.yAxis,this.options.margin.left);this.xAxisSelection=this.svg.chart.append("g").attr("class","x axis");this.yAxisSelection=this.svg.chart.append("g").attr("class","y axis");this.groups=this.svg.chart.selectAll(".barGroup").data(a).enter().append("g").attr("class",function(a,b){return"barGroup barGroup-"+
b+" "+a.label});this.barGroups=this.groups.append("g").attr("class",function(a,b){return"bar bar-"+b});this.barGroupsWithoutTotal=this.barGroups.filter(function(a,b){return 0!==b});this.bars=this.barGroupsWithoutTotal.append("rect");this.dotGroups=this.barGroupsWithoutTotal.append("g").attr("class","drag-handle-group");this.dots=this.dotGroups.append("circle").attr("r",this.options.dotSize);this.innerDots=this.dotGroups.append("circle").attr("r",this.options.dotSize/2);this.tooltips=this.barGroupsWithoutTotal.append("text").attr("text-anchor",
"middle");this.totalBarGroup=this.barGroups.filter(function(a,b){return 0===b}).datum({value:this.sum(),label:b.domainLabel}).append("g").attr("class","total");this.totalBarBackground=this.totalBarGroup.append("rect").attr("class","background");this.totalBar=this.totalBarGroup.append("rect").attr("class","sum");this.totalBarTooltip=this.totalBarGroup.append("text").attr("text-anchor","middle");return this.render()};return c}(AbstractChart$$module$target$coffeescript$goals_chart);var AbstractChart$$module$target$coffeescript$histogram,Histogram$$module$target$coffeescript$histogram,MarginCalculator$$module$target$coffeescript$histogram,Tooltip$$module$target$coffeescript$histogram,defaultHistogramOptions$$module$target$coffeescript$histogram,bind$$module$target$coffeescript$histogram=function(d,c){return function(){return d.apply(c,arguments)}},extend$$module$target$coffeescript$histogram=function(d,c){function b(){this.constructor=d}for(var a in c)hasProp$$module$target$coffeescript$histogram.call(c,
...
yRange:[this.svg.height,0],xTransform:"translate(0, "+this.svg.height+")",yTransform:"",barsTransform:function(b){return function(a){return"translate("+b.x(a.x)+", "+b.y(a.y)+")"}}(this),barWidth:function(a){return function(c){return a.x(b.x+b.dx)-a.x(b.x)-1}}(this),barHeight:function(a){return function(b){return a.svg.height-a.y(b.y)}}(this)}):(this.options.grid?this.yAxis.tickSize(-this.svg.height,0):void 0,{xRange:[0,this.svg.height],yRange:[0,this.svg.width],xTransform:"",yTransform:"translate(0, "+
...
return b.area(a.values)}}(this));return this.dots.attr("cx",function(b){return function(a){return b.x(a.x)}}(this)).attr("cy",function(b){return function(a){return b.y(a.y+a.yTranslation)}}(this))};c.prototype.chooseInterpolation=function(b){return b.smooth?"monotone":"linear"};c.prototype.formatData=function(b,a){var c,d,f,g,h,m,k,l,p,q,z,A,r,t,y,u,v,w,x;null==a&&(a=!1);h=this.isTimeSeries&&"number"===typeof b.labels[0]?b.labels.map(function(a){return new Date(a)}):b.labels;v=u=r=t=null;p=[];k=b.lines;
f=c=0;for(m=k.length;c<m;f=++c)for(g in l=k[f],p.push({values:Array(l.values.length)}),l)q=l[g],"values"!==g&&(p[f][g]=q);f=q=0;for(m=h.length;q<m;f=++q)for(g=h[f],w=c=0,A=b.lines,d=z=0,k=A.length;z<k;d=++z){l=A[d];y=l.values[f];x=y+w;if(null==t||t>g)t=g;if(null==r||r<g)r=g;if(null==v||v>x)v=x;if(null==u||u<x)u=x;d=p[d];null!=l.baselineValues&&(c=l.baselineValues[f]);d.values[f]={x:g,y:y,yTranslation:w,areaY0:c,lineKey:l.label};a&&(w+=y)}return{labels:h,lines:p,xDomain:[t,r],yDomain:["log"===this.options.yScale?
