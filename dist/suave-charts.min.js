...
k.domain()[1]));b.value=c;d3.select(this).attr("cy",k(c));b=d3.select(this.parentNode);b.select("rect").attr("height",a.barHeight({value:c})).attr("y",a.barY({value:c}));b.select("text").attr("y",function(b){return a.barY(b)-f}).text(g(c));e=d();h.each(function(a){return a.value=e});h.attr("height",a.barHeight({value:e})).attr("y",a.barY({value:e}));return m.attr("y",a.barY({value:e})-f).text(g(e))});b.on("dragend",function(a){if(null!=c)return c({label:a.label,value:a.value,remaining:d()})});return this.dots.attr("cx",
function(b){return function(b){return a.barX(b)+.5*a.barWidth()}}(this)).attr("cy",function(b){return function(c){return a.barY(c)+.5*b.options.dotSize}}(this)).attr("class","drag-handle").call(b)};c.prototype.wrap2=function(b,a){return b.each(function(){var a,c,d;b=d3.select(this);d=b.attr("y");a=parseFloat(b.attr("dy"));a=parseFloat(b.attr("dy"));c=b.text().split(/([0-9]+ year.*)/);b.text(null);return c.forEach(function(c,n){return b.append("tspan").attr("x",0).attr("y",d).attr("dy",1.5*n+a+"em").text(c)})})};
c.prototype.wrap=function(b,a){return b.each(function(){var c,d,f,g,h,m,k,l;b=d3.select(this);k=b.text().split(/\s+/).reverse();d=[];f=0;l=b.attr("y");c=parseFloat(b.attr("dy"));h=b.text(null).append("tspan").attr("x",0).attr("y",l).attr("dy",c+"em");for(g=[];m=k.pop();)d.push(m),h.text(d.join(" ")),h.node().getComputedTextLength()>a?(d.pop(),h.text(d.join(" ")),d=[m],g.push(h=b.append("tspan").attr("x",0).attr("y",l).attr("dy",1.1*++f+c+"em").text(m))):g.push(void 0);return g})};c.prototype.draw=
function(b){c.__super__.draw.call(this);this.onChangeCallback=b.onChangeCallback;return this.waitToBeInDom(function(a){return function(){return a.drawInternal(b)}}(this))};c.prototype.drawInternal=function(b){var a;a=[{value:b.bars.reduce(function(a,b){return a+b},0),label:b.domainLabel}];b.bars.forEach(function(c,d){return a.push({value:c,label:b.labels[d]})});this.y.domain(b.domain);this.x.domain(a.map(function(a){return a.label}));this.options.margin.left=this.calc.calcLeftMargin(this.yAxis,this.options.margin.left);
this.xAxisSelection=this.svg.chart.append("g").attr("class","x axis");this.yAxisSelection=this.svg.chart.append("g").attr("class","y axis");this.groups=this.svg.chart.selectAll(".barGroup").data(a).enter().append("g").attr("class",function(a,b){return"barGroup barGroup-"+b+" "+a.label});this.barGroups=this.groups.append("g").attr("class",function(a,b){return"bar bar-"+b});this.barGroupsWithoutTotal=this.barGroups.filter(function(a,b){return 0!==b});this.bars=this.barGroupsWithoutTotal.append("rect");
this.dots=this.barGroupsWithoutTotal.append("circle").attr("r",this.options.dotSize);this.tooltips=this.barGroupsWithoutTotal.append("text").attr("text-anchor","middle");this.totalBarGroup=this.barGroups.filter(function(a,b){return 0===b}).datum({value:this.sum(),label:b.domainLabel}).append("g").attr("class","total");this.totalBarBackground=this.totalBarGroup.append("rect").attr("class","background");this.totalBar=this.totalBarGroup.append("rect").attr("class","sum");this.totalBarTooltip=this.totalBarGroup.append("text").attr("text-anchor",
"middle");return this.render()};return c}(AbstractChart$$module$target$coffeescript$goals_chart);var AbstractChart$$module$target$coffeescript$histogram,Histogram$$module$target$coffeescript$histogram,MarginCalculator$$module$target$coffeescript$histogram,Tooltip$$module$target$coffeescript$histogram,defaultHistogramOptions$$module$target$coffeescript$histogram,bind$$module$target$coffeescript$histogram=function(d,c){return function(){return d.apply(c,arguments)}},extend$$module$target$coffeescript$histogram=function(d,c){function b(){this.constructor=d}for(var a in c)hasProp$$module$target$coffeescript$histogram.call(c,
