...
case "hours":return d3.time.hours;case "days":return d3.time.days;case "months":return d3.time.months;case "years":return d3.time.years}}.call(this),this.xAxis.ticks(c)):this.options.ticks&&this.xAxis.ticks(this.options.ticks);this.options.xTickFormat&&this.xAxis.tickFormat(d3.time.format(this.options.xTickFormat));this.xAxisSelection.call(this.xAxis);return this.yAxisSelection.call(this.yAxis)};b.prototype.newAxis=function(a,d){return d3.svg.axis().scale(a).orient(d).tickPadding(this.options.tickPadding)};
return b}();var defaultOptions;defaultOptions={xScale:"linear",yScale:"linear",smoothLines:!1,tooltips:!0,aspectRatio:"16:9",tickPadding:20,dotSize:6,grid:!0,margin:{top:50,bottom:50,right:80,left:80}};var LineChart,bind=function(b,a){return function(){return b.apply(a,arguments)}},extend=function(b,a){function d(){this.constructor=b}for(var c in a)hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b},hasProp={}.hasOwnProperty;
...
return a.line(d.data)}}(this));this.area.y0(this.height);this.areas.attr("d",function(a){return function(d){a.area.interpolate(a.chooseInterpolation(d));return a.area(d.data)}}(this));return this.dots.attr("cx",this.scales.scaleX).attr("cy",this.scales.scaleY)};a.prototype.chooseInterpolation=function(a){return a.smooth?"cardinal":"linear"};a.prototype.draw=function(a){var b,e;b=d3.merge(function(){var b,c,f;f=[];b=0;for(c=a.length;b<c;b++)e=a[b],f.push(e.data);return f}());this.scales.setDomains(b);
this.lineGroups=this.svg.chart.selectAll(".lineGroup").data(a,function(a){return a.label});b=this.lineGroups.enter().append("g").attr("class","lineGroup");this.enterLines(b);this.enterAreas(b);this.lines=this.lineGroups.selectAll(".line");this.areas=this.lineGroups.selectAll(".area");this.dots=this.lineGroups.selectAll(".dot");this.dots=this.dots.data(function(a){var b,d,c,e,g;if(!1===a.dots)return[];e=a.data;g=[];d=0;for(c=e.length;d<c;d++)b=e[d],g.push([b[0],b[1],a.label]);return g});this.dots.enter().append("circle").attr("class",
function(a){return"dot "+a[2]}).attr("r",this.options.dotSize);this.options.tooltips&&this.createTooltip();return this.render(!1)};return a}(AbstractChart);var Scales,bind=function(b,a){return function(){return b.apply(a,arguments)}};
...
b.prototype.scaleY=function(a){return this.y(a[1])};b.prototype.setDomains=function(a){this.x.domain(d3.extent(a,function(a){return a[0]}));return this.y.domain([0,d3.max(a,function(a){return a[1]})])};b.prototype.setRanges=function(a,b){this.x.range([0,a]);return this.y.range([b,0])};return b}();var ScatterPlot,extend=function(b,a){function d(){this.constructor=b}for(var c in a)hasProp.call(a,c)&&(b[c]=a[c]);d.prototype=a.prototype;b.prototype=new d;b.__super__=a.prototype;return b},hasProp={}.hasOwnProperty;
